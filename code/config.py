...
class PoseGraphConfig:
    ...
    max_proximity_candidates: int = 30
    icp_max_iterations: int = 30
    icp_max_correspondence_distance: float = 0.75
    icp_min_overlap: float = 0.50
    icp_max_rmse: float = 0.20
    icp_max_translation_correction: float = 0.50
    icp_max_yaw_correction: float = 0.15
